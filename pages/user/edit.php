...
<table class="table table-sm table-middle">
  <tr>
    ...
    <td width="1%">:</td>
    <td><input type="text" class="form-control" name="desa_kelurahan_user" value="<?php echo $data_user[0]['desa_kelurahan_user'] ?>" required readonly></td>
  </tr>
  <tr>
    <th>Kecamatan</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="kecamatan_user" value="<?php echo $data_user[0]['kecamatan_user'] ?>" required readonly></td>
  </tr>
  <tr>
    <th>Kabupaten/Kota</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="kabupaten_kota_user" value="<?php echo $data_user[0]['kabupaten_kota_user'] ?>" required readonly></td>
  </tr>
  <tr>
    <th>Provinsi</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="provinsi_user" value="<?php echo $data_user[0]['provinsi_user'] ?>" required readonly></td>
  </tr>
  <tr>
    <th>Negara</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="negara_user" value="<?php echo $data_user[0]['negara_user'] ?>" required readonly></td>
  </tr>
  <tr>
    <th>RT</th>
    <td>:</td>
